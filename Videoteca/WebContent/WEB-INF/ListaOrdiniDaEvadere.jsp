	...
	<div class="container">
		  <div class="row">
		    ...
		    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
				...
				<h4>Lista Ordini Da Evadere</h4>
					<% List<Noleggio> noleggio = (List<Noleggio>) request.getAttribute("listaNoleggi");%>
						<table class="table table-bordered table-striped text-center">
							...
							<%for(int i=0; i < noleggio.size();i++){%>
							<tr>
								<td><%=noleggio.get(i).getUtente().getEmail() %></td>
								
								<td><%=noleggio.get(i).getFilm().getTitolo() %></td>
								
								<td><%=noleggio.get(i).getFilm().getCopie() %></td>
